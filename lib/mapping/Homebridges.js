...
Homebridges.prototype.getDevicesHBName = function(devices, log) {
  return devices.filter(Boolean).map(device_data => this.checkThatDeviceExists(device_data, log)?.homebridge.hb_name)
}
